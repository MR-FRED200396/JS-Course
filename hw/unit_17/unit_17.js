...
function t9() {
    a9.forEach((item) => {
        return a9New.push(item.toLowerCase());
    });
    a9 = a9New;
    return a9;
}
...
function t12() {
    return Array.isArray(a12) ? true : false;
}
...
function t13() {
    return a13.includes(a13_num) ? true : false;
}
...
function t14() {
    a14.forEach((item) => {
        return a14New.push(item.toLowerCase());
    });
    a14 = a14New;
    return a14.includes(a14_sym.toLowerCase()) ? true : false;
}
