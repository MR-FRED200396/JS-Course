...
function f6() {
    a6[document.querySelector('.i-61').value] =
...
function f7() {
    ...
    let num = 0;
    if (a7[i7.value] !== undefined) num = 1;
    document.querySelector('.out-7').innerHTML = num;
}
...
function f8() {
    ...
    if (a8[i8.value] !== undefined) num = a8[i8.value];
    document.querySelector('.out-8').innerHTML = num;
}
...
function f19() {
    let out = '';
    let oldI19 = document.querySelector('.i-19').value;
    let i19 = oldI19[0].toUpperCase() + oldI19.slice(1);
    for (let key in a19) {
        for (let i = 0; i < 4; i++) {
            if (i19 == a19[key][i]) out = key;
        }
    }
