...
const f4 = () => {
    ...
    let out4 = (document.querySelector('.out-4').innerHTML = s4.has(i4));
};
...
const f5 = () => {
    let out5 = (document.querySelector('.out-5').innerHTML = s5.size);
};
...
let a6 = [
    1, 2, 3, 4, 5, 3, 4, 5, 2, 4, 5, 3, 24, 5, 2, 4, 56, 4, 3, 2, 335, 2, 23,
    41, 3, 4, 1, 1, 4, 2, 2, 4, 5, 24, 5, 3, 22, 56,
];

const f6 = () => {
    let s6 = new Set(a6);
    let out6 = (document.querySelector('.out-6').innerHTML = s6.size);
};
...
let s8 = new Set([
    1, 2, 3, 4, 5, 3, 4, 7, 9, 5, 7, 8, 9, 23, 45, 5, 2, 4, 5, 3, 24, 5, 2, 4,
    56, 4, 3, 2, 335, 2, 23, 41, 3, 4, 1, 1, 4, 2, 2, 4, 5, 24, 5, 3, 22, 56,
]);
let ar8 = [];
const f8 = () => {
    for (let item of s8) {
...
const f9 = (our_set) => {
    our_set = Array.from(our_set);
    let out9 = '';
    for (let i = 0; i < our_set.length; i++) {
        out9 += our_set[i] + ' ';
    }
    return out9;
};
...
const f10 = (out_set, elem) => {
    out_set = Array.from(out_set);
    let out = '';
    for (let i = 0; i < out_set.length; i++) {
        out += out_set[i] + ' ';
    }
